		...
		<div class="row">
			<div class="col-md-2" id="menu-painel">					
				<div class="list-group" id="list-tab" role="tablist">
						...
						<a class="list-group-item list-group-item-action" id="list-settings-list"  href="#list-settings" role="tab" aria-controls="settings">Cadastrar administrador</a>
						<a class="list-group-item list-group-item-action" id="list-settings-list"  href="#list-settings" role="tab" aria-controls="settings">Excluir administrador</a>
			...
			<div class="col-md-10" id="corpo-painel">
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-8" id="meus-anuncios">
							<div class="row">
								<div class="col-md-3" id="foto-meu-anuncio">
									<img src="https://picsum.photos/100/?random" alt="imagem do anuncio" width="100%" height="110px">
								</div>
								<div class="col-md-9" id="info-meu-anuncio">
									<h4 id="titulo-meu-anuncio">Titulo do anuncio</h4>
									<p id="preco-anuncio">R$XX,XX</p>
									<button type="submit" class="btn btn-outline-secondary" id="botao-excluir-anuncio" width="100%" onclick="javascript: location.href='produto.php';">Excluir Anuncio</button>
								</div>
							</div>
						</div>
						<div class="col-md-2"></div>
