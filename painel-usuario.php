		...
		<div class="row">
			<div class="col-md-2" id="menu-painel">					
				<div class="list-group" id="list-tab" role="tablist">
						...
						<a class="list-group-item list-group-item-action" id="list-settings-list"  href="#list-settings" role="tab" aria-controls="settings">Excluir anuncio</a>
			...
			<div class="col-md-10" id="corpo-painel">
				<div class="container-fluid">
					<div class="row">
						<img src="images/2.png" alt="Bem vindo">
					</div>
				</div>
			</div>
		</div>
