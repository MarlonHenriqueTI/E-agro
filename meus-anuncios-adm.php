			...
			<div class="col-md-2" id="menu-painel">					
				<div class="list-group" id="list-tab" role="tablist">
					<a class="list-group-item list-group-item-action" id="list-settings-list"  href="banner.php" role="tab" aria-controls="settings">Alterar Banner</a>
						...
						<a class="list-group-item list-group-item-action" id="list-settings-list"  href="cadastrar-adm.php" role="tab" aria-controls="settings">Cadastrar administrador</a>
						...
						<div class="col-md-8" id="meus-anuncios">
							<div class="row">
								...
								<div class="col-md-9" id="info-meu-anuncio">
									...
									<button type="submit" class="btn btn-outline-secondary" id="botao-meu-anuncio" width="100%" onclick="javascript: location.href='produto.php';">Ver anuncio</button>
								</div>
							</div>
						</div>
						<div class="col-md-2"></div>
