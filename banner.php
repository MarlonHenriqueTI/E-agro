		...
		<div class="row">
			...
			<div class="col-md-10" id="corpo-painel">
					...
					<div class="col-md-8" id="formulario-cadastro">
						<form method="POST" action="" id="cadastro-anuncio">
							 <div class="form-group">
							    <label for="exampleFormControlFile1">Adicionar um novo Banner</label>
				...
				<div class="col-md-2"></div>
					...
					<div class="row">
					<div class="col-md-2"></div>
						<div class="col-md-8" id="meus-banners">
							<div class="row">
								<div class="col-md-12" id="foto-meu-anuncio">
									<img src="https://picsum.photos/300/?random" alt="imagem do banner" width="100%" height="200px">
								</div>
							</div>
						</div>
						<div class="col-md-2"></div>
